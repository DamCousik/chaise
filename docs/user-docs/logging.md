...
|------------------------------------|----------------------------|-----------------------------|-----------------------|--------------------------------------------------------------------------------------------------------------------------------|-------------------------------|
| record/recordset                   | delete clicked             | delete/intend               | rid                   | Delete was clicked from the main record page and confirm delete was shown. (use cid to determine app)                          |                               |
| record/recordset                   | confirm delete cancelled   | delete/cancel               | rid                   | User closed the confirm delete modal without deleting                                                                          |                               |
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
...
| recordset                          | facet opened               | facet-header/open           | main_st, source       | A facet header was opened                                                                                                      |                               |
| recordset                          | facet closed               | facet-header/close          | main_st, source       | A facet header was closed                                                                                                      |                               |
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
| record                             | show empty sections        | show-empty/show             | rid                   | "Show empty sections" button clicked in submenu bar                                                                            |                               |
| record                             | hide empty sections        | show-empty/hide             | rid                   | "Hide empty sections" button clicked in submenu bar                                                                            |                               |
| record                             | share popup                | share                       | rid                   | Share dialog was opened                                                                                                        |                               |
| record                             | copy live link             | share/live                  | rid                   | Live link was copied to clipboard                                                                                              |                               |
| record                             | copy version link          | share/version               | rid                   | Versioned link was copied to clipboard                                                                                         |                               |
| record                             | cite, download bibtex      | cite/bibtex                 | rid                   | Bibtex citation downloaded                                                                                                     |                               |
| record                             | Scroll top clicked         | scroll-top                  | rid                   | Bottom right, "Scroll to top" button clicked                                                                                   |                               |
| record                             | ToC panel open             | toc/show                    | rid                   | "Show side panel" button clicked                                                                                               |                               |
| record                             | ToC panel collapse         | toc/hide                    | rid                   | "Hide panel" button clicked                                                                                                    |                               |
| record                             | Scroll top clicked         | toc/scroll-top              | rid                   | first heading in Table of contents clicked (Summary)                                                                           |                               |
| record                             | ToC panel options selected | toc/scroll-to               | main_rid, main_st, source | Related table heading clicked in Table of contents                                                                         |                               |
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
| record                             | toggle related table open  | related/open                | main_rid, main_st, source | Related table section toggled open                                                                                         |                               |
| record                             | toggle related table close | related/close               | main_rid, main_st, source | Related table section toggled close                                                                                        |                               |
| record                             | items per page dropdown    | related/page-size           | main_rid, main_st, source | Dropdown was opened for related table. Selecting a page size will trigger a read request.                                  |                               |
| record                             | Table mode                 | related/display/table       | main_rid, main_st, source | User changed display format to show table display (user does not have permission to edit)                                  |                               |
| record                             | Custom mode                | related/display/mkdn        | main_rid, main_st, source | User changed display format to show markdown display (for both edit and not edit permission)                               |                               |
| record                             | Edit mode                  | related/display/edit        | main_rid, main_st, source | User changed display format to show table display (user has permission to edit)                                            |                               |
| record                             | row delete clicked         | related/delete/intend       | main_rid, main_st, source, rid | Delete was clicked from related table and confirm delete was shown (for both edit and not edit permission)            |                               |
| record                             | confirm delete cancelled   | related/delete/cancel       | main_rid, main_st, source, rid | User closed the confirm delete modal without deleting                                                                 |                               |
| record                             | row unlink clicked         | related/unlink/intend       | main_rid, main_st, source, rid | Unlink was clicked from related table and confirm unlink was shown (for both edit and not edit permission)            |                               |
| record                             | confirm unlink cancelled   | related/unlink/cancel       | main_rid, main_st, source, rid | User closed the confirm unlink modal without unlinking                                                                |                               |
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
| record                             | items per page dropdown    | inline/page-size            | main_rid, main_st, source | Dropdown was opened for inline related table. Selecting a page size will trigger a read request.                           |                               |
| record                             | Table mode                 | inline/display/table        | main_rid, main_st, source | User changed display format to show table display (user does not have permission to edit)                                  |                               |
| record                             | Custom mode                | inline/display/mkdn         | main_rid, main_st, source | User changed display format to show markdown display (for both edit and not edit permission)                               |                               |
| record                             | Edit mode                  | inline/display/edit         | main_rid, main_st, source | User changed display format to show table display (user has permission to edit)                                            |                               |
| record                             | row delete clicked         | inline/delete/intend        | main_rid, main_st, source, rid | Delete was clicked from inline related table and confirm delete was shown (for both edit and not edit permission)     |                               |
| record                             | confirm delete cancelled   | inline/delete/cancel        | main_rid, main_st, source, rid | User closed the confirm delete modal without deleting                                                                 |                               |
| record                             | row unlink clicked         | inline/unlink/intend        | main_rid, main_st, source, rid | Unlink was clicked from inline related table and confirm unlink was shown (for both edit and not edit permission)     |                               |
| record                             | confirm unlink cancelled   | inline/unlink/cancel        | main_rid, main_st, source, rid | User closed the confirm unlink modal without unlinking                                                                |                               |
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
...
| recordedit                         | open set all               | create/set-all/open         | column, source        | set all row opened, referrer used for FK rows (pencil icon button)                                                             |                               |
| recordedit                         | close set all              | create/set-all/close        | column, source        | set all row closed, referrer used for FK rows (chevron up icon button)                                                         |                               |
| recordedit                         | cancel set all             | create/set-all/cancel       | column, source        | set all row closed, referrer used for FK rows ("Cancel" button)                                                                |                               |
| recordedit                         | apply set all              | create/set-all/apply        | column, source        | set all row applied, referrer used for FK rows ("Apply All" button)                                                            |                               |
| recordedit                         | clear all                  | create/set-all/clear        | column, source        | set all row cleared, referrer used for FK rows ("Clear All" button)                                                            |                               |
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
| recordedit                         | remove form                | update/remove               | rid                   | 1 form was removed from being updated                                                                                          |                               |
| recordedit                         | open set all               | update/set-all/open         | column, source        | set all row opened, referrer used for FK rows (pencil icon button)                                                             |                               |
| recordedit                         | close set all              | update/set-all/close        | column, source        | set all row closed, referrer used for FK rows (chevron up icon button)                                                         |                               |
| recordedit                         | cancel set all             | update/set-all/cancel       | column, source        | set all row closed, referrer used for FK rows ("Cancel" button)                                                                |                               |
| recordedit                         | apply set all              | update/set-all/apply        | column, source        | set all row applied, referrer used for FK rows ("Apply All" button)                                                            |                               |
| recordedit                         | clear all                  | update/set-all/clear        | column, source        | set all row cleared, referrer used for FK rows ("Clear All" button)                                                            |                               |
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
...
| recordset                          | items per page dropdown    | facet/page-size             | main_st, source       | In facet "show more" popup, dropdown was opened. Selecting a page size will trigger a read request                             |                               |
| recordset                          | All on page                | facet/all                   | main_st, source       | In facet "show more" popup, "All on page" button clicked                                                                       |                               |
| recordset                          | None on page               | facet/none                  | main_st, source       | In facet "show more" popup, "None on page" button clicked                                                                      |                               |
| recordset                          | Reset selection            | facet/reset                 | main_st, source       | In facet "show more" popup, "Reset selection" button clicked to remove selections                                              |                               |
| recordset                          | Modal closed               | facet/cancel                | main_st, source       | In facet "show more" popup, modal closed with no selection made                                                                |                               |
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
| record                             | facet panel open           | pb/panel/show               | main_st, source       | In pure & binary "Add record" popup, "Show filter panel" button clicked                                                        |                               |
| record                             | facet panel close          | pb/panel/hide               | main_st, source       | In pure & binary "Add record" popup, "Hide panel" button clicked                                                               |                               |
| record                             | items per page dropdown    | pb/page-size                | main_st, source       | In pure & binary "Add record" popup, dropdown was opened. Selecting a page size will trigger a read request                    |                               |
| record                             | All on page                | pb/all                      | main_st, source       | In pure & binary "Add record" popup, "All on page" button clicked                                                              |                               |
| record                             | None on page               | pb/none                     | main_st, source       | In pure & binary "Add record" popup, "None on page" button clicked                                                             |                               |
| record                             | Reset selection            | pb/reset                    | main_st, source       | In pure & binary "Add record" popup, "Reset selection" button clicked to remove selections                                     |                               |
| record                             | Modal closed               | pb/cancel                   | main_st, source       | In pure & binary "Add record" popup, modal closed with no selection made                                                       |                               |
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
...
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
| recordedit                         | facet panel open           | fk/panel/show               | main_st, source       | In foreign key popup, "Show filter panel" button clicked                                                                       |                               |
| recordedit                         | facet panel closed         | fk/panel/hide               | main_st, source       | In foreign key popup, "Hide panel" button clicked                                                                              |                               |
| recordedit                         | items per page dropdown    | fk/page-size                | main_st, source       | In foreign key popup, dropdown was opened. Selecting a page size will trigger a read request                                   |                               |
| recordedit                         | Modal closed               | fk/cancel                   | main_st, source       | In foreign key popup, modal closed with no selection made                                                                      |                               |
|                   &ensp;           |                            |                             |                       |                                                                                                                                |                               |
